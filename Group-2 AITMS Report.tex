...
\begin{document} % Begin document "environment".
	...
	\begin{titlepage}
		\begin{center}
			...
			{\bf Mr. Saquib Akhtar Aneesur Rahman}\hspace*{\fill}{\bf (Seat No. B150474298)}\\
			{\bf Mr. Giwil Gidwani }\hspace*{\fill}{\bf (Seat No. B150474245)}\\
			{\bf Mr. Vrushabh Dattatray Nikam     }\hspace*{\fill}{\bf (Seat No. B150474278)}\\
			{\bf Mr. Rutuja Rajesh Shinde    }\hspace*{\fill}{\bf (Seat No. B150474304)}\\
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=5.5 in]{./Diagrams/PNG/uml2}
	...
	\begin{comment}	
		...
		\begin{figure}[H]
			\centering
			\includegraphics[width=5.2in]{./Diagrams/PNG/cc}
	...
	\hspace*{0.5in}Thus the various modeling techniques used for the design of Artificially Intelligent Traffic Management System were seen in this chapter.
		...
		\begin{figure}[H]
			...
			\caption{ATIMS Scene Creation Screen}
		\end{figure}
		
		\begin{figure}[H]
			\centering
			\includegraphics[width=6in]{./Diagrams/PNG/cross}
			\caption{ATIMS Simulation Screen}
		\end{figure}
		
		\begin{figure}[H]
			\centering
			\includegraphics[width=6in]{./Diagrams/PNG/licescene2}
			\caption{ATIMS Simulation Screen (Intersection)}
		\end{figure}
		
		\begin{figure}[H]
			\centering
			\includegraphics[width=6in]{./Diagrams/PNG/livescene}
			\caption{ATIMS Simulation Screen (Roundabout)}
		\end{figure}
		
		\begin{figure}[H]
			\centering
			\includegraphics[width=6in]{./Diagrams/PNG/scene2}
			\caption{ATIMS Game View Screen}
		\end{figure}
		
		\begin{figure}[H]
			\centering
			\includegraphics[width=6in]{./Diagrams/PNG/fulllive}
			\caption{ATIMS Map Viewer}
		\end{figure}
		
		\begin{figure}[H]
			\centering
			\includegraphics[width=6in]{./Diagrams/PNG/prefabs}
			\caption{ATIMS NavSection Prefabs}
		\end{figure}
		
		\begin{figure}[H]
			\centering
			\includegraphics[width=6in]{./Diagrams/PNG/agent}
			\caption{ATIMS Agent Prefabs}
		\end{figure}
		
		\begin{figure}[H]
			\centering
			\includegraphics[width=6in]{./Diagrams/PNG/graph}
			\caption{ATIMS Training Progress Graph (Rewards vs Steps)}
		\end{figure}		
		
		\begin{figure}[H]
			\centering
			\includegraphics[width=6in]{./Diagrams/PNG/result}
			\caption{ATIMS Training Result Graph (AvgWait vs SimulationTime) Showing Approximately 27 \% Improvement}
		\end{figure}	
