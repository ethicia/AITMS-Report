...
{\bf Mr. Saquib Akhtar Aneesur Rahman}\hspace{0.32in}  {\bf (Exam Seat No: B8474255)}\\
{\bf Mr. Giwil Gidwani }\hspace{0.3in} {\bf (Exam Seat No: B8474227)}\\
{\bf Mr. Vrushabh Nikam Dattatray     }\hspace{0.5in}  {\bf (Exam Seat No: B8474225)}\\
{\bf Mr. Rutuja Rajesh Shinde    }\hspace{0.43in}  {\bf (Exam Seat No: B8474206)}\\
...
{\bf Mr. Saquib Akhtar Aneesur Rahman}\hspace{0.0in}  {\bf (Exam Seat No:B8474255)}\\
{\bf Mr. Giwil Gidwani  }\hspace{0.3in} {\bf (Exam Seat No:B8474227)}\\
{\bf Mr. Vrushabh Nikam Dattatray     }\hspace{0.0in}  {\bf (Exam Seat No:B8474225)}\\
{\bf Ms. Rutuja Rajesh Shinde    }\hspace{0.43in}  {\bf (Exam Seat No:B8474206)}\\
\end{center}
\vspace{0.3in}
...
\hspace*{0.5in}The Global Renaissance in Education is happening as the mankind has realized that to solve tomorrows problems we have to globally unite and education will remain at the forefront of everything. Government's objective is to raise the Gross Enrollment Ratio to over 30 percent by 2020. As a result the Enrollment in University System are expected to rise to 45 Million
students from current 15 Million by 2020 and as a result the number of Universities will increase to 1000+ from current 500+ Universities by 2020. Another 45000 Colleges will be required to raise the Gross Enrollment Ratio, these requirements introduce the need of M-Learning. M-Learning can be thought of as delivering eLearning on small form factor devices and it has the potential to do much more than deliver courses, or parts of courses. It includes the use of mobile/hand-held devices to deliver Education/Learning.\\
\\
\hspace*{0.5in}Our project basically focuses on providing an environment that will help develop M-Learning applications for learners. The architecture of M-Learning framework encompasses of system specifications and an actual working application based on Android 2.2 (Froyo), Android 2.3 (Gingerbread), Android 3.0 (Honeycomb) and Android 4.0 (Ice Cream Sandwich) platforms. The M-Learning framework will also import Engineering learning contents from Cognifront. The framework will also provide SD-card based M-Learning, it will include Animated/Multimedia/2D/3D based content and Interactive 2D/3D content. The framework will include Cognitive Science Research Implementations carried out recently at Cognifront by the prodigies in the field of education.\\
...
\section{Gartner's Report 2011}
\hspace*{0.5in}Gartner estimates that by the end of 2012, 5 billion people will carry handsets capable of rich, mobile commerce providing an ideal environment for the convergence of mobility and the Web. Mobile devices are becoming computers in their own right, with an astounding amount of processing ability and bandwidth. There are already hundreds of thousands of applications for platforms like the Apple iPhone, in spite of the limited market (only for the one platform) and need for unique coding.
\\
\hspace*{0.5in}The quality of the experience of applications on these devices, which can apply location, motion and other context in their behavior, is leading customers to interact with companies preferentially through mobile devices. This has lead to a race to push out applications as a competitive tool to improve relationships and gain advantage over competitors whose interfaces are purely browser-based.

\section{Evolution towards M-Learning, Marela Andres}
\hspace*{0.5in}The integration of technology in education forms a new breed of learning called M-Learning or mobile learning. In the broadest terms, M-Learning is the learning process that the learner goes through while using mobile technologies. Mobile technologies are devices which include laptops, MP3 players, notebooks, and mobile phones. These gadgets remove the need for the student to be in a fixed position (e.g., in the classroom) to learn; thus increasing mobility in one’s education. This paper focuses on the necessary changes in learners, teachers, technologies and educational institutions in order to make use of the learning opportunities that M-Learning offers\cite{paper9}.

\section{Managed M-Learning, Greg Luckock}
\hspace*{0.5in}Research In Motion (RIM) sold over 50,000,000 Blackberry devices in the past ten years according to an April 2009 article on mobilewack.com. It also states that RIM announced the number of current users surpassed 25 million. Of that, 3.9 million were added in the first quarter of 2009 alone. The article claims Blackberry is now available in 150 countries from roughly 425 carriers, these statistics are only for Blackberry. When all the other Windows mobile, Apple, Palm and other smart-phone devices are added to that number, it seems obvious to those of us in the training industry that there is a very large audience of potential learners who use mobile devices daily.
\\
\hspace*{0.5in}The dilemma for learning professionals has been to find a way to leverage the audience's familiarity with these devices for training solutions. In an attempt to capitalize on the popularity and portability of mobile devices, early-applications of M-Learning have focused on getting the content to the learners, not tracking their interactions and results\cite{paper10}.

\section{Summary}
\hspace*{0.5in}In this chapter we discussed the various researches conducted in order to achieve a clear view of mobile learning framework and also understand the needs of users who are attracted towards digital education.
%*************************Chapter 3 ************************
...
\bibitem{paper1}\emph{Individualized revision material for use on a handheld computer}; Bull S. \&  Reid E., In J. Attewell, G. Da Bormida, M. Sharples and C. Savill-Smith (Eds.),mlearn, 2008.
\bibitem{paper3}\emph{A Design Requirements Framework for Mobile Learning Environments};David Parsons, Hokyoung Ryu and Mark Cranshaw,In Journal of Computers, June 2009.
\bibitem{paper4}\emph{Mobile learning in the 21st century: Benefit for learners};Geddes S.,In The knowledge tree, December 2010.
\bibitem{paper5}\emph{Mobile learning: A handbook  for educators and trainers};Kukulska-Hulme, A., and Traxler, J.,In London: Routledge,2010.
\bibitem{paper6}\emph{Moving mobile into the mainstream};Stead, G.,In Proceedings of mLearn,2010.
\bibitem{paper7}\emph{Mobile learning anytime everywhere};Corlett and Sharples, In London: Learning and Skills Development Agency, 2010.
\bibitem{paper8}\emph{Cooperative learning: Increasing college faculty instructional productivity};Johnson, In Washington  D.C.: School of Education and Human Development, 2011.
\bibitem{paper9}\emph{Evolution towards M-Learning},Marela Andres, EdTechie, 2011.
\bibitem{paper10}\emph{Managed M-Learning}, Greg Luckock, RPS, 2011.
